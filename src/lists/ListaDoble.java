...
public class ListaDoble<T> implements Iterable<T> {
	...
	/**
	 * Devuelve el Listas.Nodo de una lista dada su posici�n
	 * @param indice �ndice para obtener el Listas.Nodo
	 * @return Listas.Nodo objeto
	 */
	...
	public void setTamanio(int size) {
		this.tamanio = size;
	}
