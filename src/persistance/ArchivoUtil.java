...
//		Empresa empresa = null;
    ...
    public static void guardarRed(String rutaArchivoUsuarios, Notes notes) {
		try {
			FileOutputStream archivoSalida = new FileOutputStream(rutaArchivoUsuarios);
			ObjectOutputStream objetoSalida = new ObjectOutputStream(archivoSalida);
			objetoSalida.writeObject(notes);
			objetoSalida.close();
			archivoSalida.close();
			System.out.println("El objeto Vendedor ha sido guardado en el archivo.");
		} catch (IOException e) {
			e.printStackTrace();
		}
	...
	public static Notes cargarRed(String ruta) {
		Notes notes = null;
		try {
			FileInputStream archivoEntrada = new FileInputStream(ruta);
			ObjectInputStream objetoEntrada = new ObjectInputStream(archivoEntrada);
			notes = (Notes) objetoEntrada.readObject();
			objetoEntrada.close();
			archivoEntrada.close();
			System.out.println("El objeto notes ha sido recuperado del archivo.");
